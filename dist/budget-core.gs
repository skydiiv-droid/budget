 ...
 * 원본: apps-script/Config.gs, apps-script/Util.gs, apps-script/Schema.gs, apps-script/Seed.gs, apps-script/Classify.gs, apps-script/Settlement.gs, apps-script/Ingest.gs, apps-script/Code.gs, apps-script/Debug.gs
 *
